#!/usr/bin/env python
"""
Summarize Gemini analysis results for double entity disclosures.

This script takes the compiled results from the Gemini entity analysis and 
generates a summary report and a CSV file for easier review in a spreadsheet.
"""
...
class GeminiResultsSummarizer:
    """
    Summarize and analyze Gemini entity analysis results.
    """
    ...
    def export_to_csv(self, results: Dict[str, Any]) -> str:
        """
        Export entity results to CSV for easier review.
        ...
        csv_file = os.path.join(self.output_dir, "entity_analysis_results.csv")
    ...
    def generate_markdown_report(self, summary: Dict[str, Any], csv_file: str) -> str:
        ...
        """
        report_file = os.path.join(self.output_dir, "gemini_analysis_report.md")
        logger.info(f"Generating markdown report to {report_file}")
        
        with open(report_file, 'w') as f:
            f.write("# Gemini Entity Analysis Report\n\n")
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Summarize Gemini entity analysis results")
